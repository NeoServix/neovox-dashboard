  ...
  return (
    <div className="min-h-screen bg-black text-gray-200 font-sans selection:bg-[#00A8E8] selection:text-white">
      ...
      <main className="pt-28 md:pt-32 pb-16 flex flex-col items-center">
        ...
        {/* Bloque 2: ¿Qué es NeoVox? */}
        <GlassSection>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 md:gap-12 items-center text-center md:text-left">
            <div>
              <h2 className="text-2xl md:text-3xl font-bold text-white mb-6">Anatomía del sistema</h2>
            ...
            <div className="space-y-4">
              <div className="bg-black/40 p-5 rounded-xl border border-white/5 flex flex-col md:flex-row items-center md:items-start gap-4">
                <div className="w-10 h-10 md:w-8 md:h-8 rounded bg-[#00A8E8]/10 text-[#00A8E8] flex items-center justify-center shrink-0">
                ...
                <div>
                  <h3 className="text-white font-bold text-sm mb-2 md:mb-1">Cero intervención manual</h3>
              ...
              <div className="bg-black/40 p-5 rounded-xl border border-white/5 flex flex-col md:flex-row items-center md:items-start gap-4">
                ...
                <div>
                  <h3 className="text-white font-bold text-sm mb-2 md:mb-1">Omnicanalidad nativa</h3>
        ...
        <GlassSection>
          <div className="text-center mb-10 md:mb-12">
            <h2 className="text-2xl md:text-3xl font-bold text-white mb-3">Tecnología de Grado Empresarial</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center md:text-left">
            <div className="p-6 md:p-8 border border-white/5 rounded-2xl bg-black/30 flex flex-col items-center md:items-start">
              <div className="text-[10px] font-mono text-[#00A8E8] mb-4 md:mb-5 border-b border-[#00A8E8]/20 pb-2 uppercase tracking-widest font-bold">NÚCLEO DE VOZ</div>
            ...
            <div className="p-6 md:p-8 border border-white/5 rounded-2xl bg-black/30 flex flex-col items-center md:items-start">
              <div className="text-[10px] font-mono text-[#00A8E8] mb-4 md:mb-5 border-b border-[#00A8E8]/20 pb-2 uppercase tracking-widest font-bold">PROCESAMIENTO</div>
            ...
            <div className="p-6 md:p-8 border border-white/5 rounded-2xl bg-black/30 flex flex-col items-center md:items-start">
              <div className="text-[10px] font-mono text-[#00A8E8] mb-4 md:mb-5 border-b border-[#00A8E8]/20 pb-2 uppercase tracking-widest font-bold">CEREBRO IA</div>
        ...
        <GlassSection>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 text-center md:text-left">
            <div className="p-6 md:p-8 bg-black/30 border border-white/5 rounded-2xl relative">
              ...
              <div className="flex flex-col md:flex-row items-center md:items-start gap-4 border-t border-white/10 pt-6">
        ...
        <GlassSection glowing={true} className="text-center">
          <div className="max-w-2xl mx-auto py-6 md:py-8">
            ...
            <Link 
              href="/registro"
              className="inline-block bg-white text-black font-bold py-4 px-8 md:py-4 md:px-12 rounded-xl hover:bg-gray-200 transition-all uppercase text-[10px] md:text-xs tracking-widest shadow-xl active:scale-[0.98]"
            >
